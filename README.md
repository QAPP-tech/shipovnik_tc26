...
Шиповник - квантово-устойчивый алгоритм электронно-цифровой подписи, реализуемый с использованием операций над кодами, исправляющими ошибки, определенными над конечным простым полем из двух элементов.

Данный репозиторий содержит реализацию этого алгоритма на языке Си.
